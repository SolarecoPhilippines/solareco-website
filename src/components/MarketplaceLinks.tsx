      ...
      <div className="mt-3 flex flex-wrap items-center gap-3">
        {marketplaceLinks.map((marketplace) => (
          <a
            ...
            className={`inline-flex h-11 items-center justify-center rounded-lg border px-3 transition duration-200 hover:-translate-y-0.5 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#0D3567] ${cardClass}`}
          >
            <Image
              src={marketplace.src}
