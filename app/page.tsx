  ...
  return (
    <>
      <section className="home-hero section-fade relative overflow-hidden bg-[#0D3567] text-white">
        ...
        <div className="relative mx-auto grid min-h-svh w-full max-w-[1650px] items-center gap-8 px-4 py-24 sm:-translate-y-4 sm:px-6 md:-translate-y-5 md:gap-6 lg:grid-cols-[42%_58%] lg:px-8 xl:-translate-y-6 xl:gap-4">
